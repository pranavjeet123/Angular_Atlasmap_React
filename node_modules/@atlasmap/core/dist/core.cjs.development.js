...
})(exports.FieldStatus || (exports.FieldStatus = {}));
...
})(exports.DocumentDefaultName || (exports.DocumentDefaultName = {}));

var collectionTypes = [[exports.CollectionType[exports.CollectionType.ARRAY], 'Array'], [exports.CollectionType[exports.CollectionType.LIST], 'List'], [exports.CollectionType[exports.CollectionType.MAP], 'Map'], [exports.CollectionType[exports.CollectionType.NONE], 'None']];
...
})(exports.Multiplicity || (exports.Multiplicity = {}));
...
})(exports.AuditStatus || (exports.AuditStatus = {}));
...
var CommonUtil = /*#__PURE__*/function () {
  ...
  CommonUtil.writeFile = function writeFile(fileContent, fName) {
    try {
      return Promise.resolve(new Promise(function (resolve) {
        fileSaver.saveAs(fileContent, fName);
        resolve(true);
      }));
    } catch (e) {
      return Promise.reject(e);
...
var Field = /*#__PURE__*/function () {
  ...
  _proto.isProperty = function isProperty() {
    return this.docDef == null ? false : this.docDef.type === exports.DocumentType.PROPERTY;
  };

  _proto.isConstant = function isConstant() {
    return this.docDef == null ? false : this.docDef.type === exports.DocumentType.CONSTANT;
  };
...
var PaddingField = /*#__PURE__*/function (_Field) {
  ...
  function PaddingField(_isSource) {
    ...
    _this.type = exports.FieldType.NONE;
...
var DocumentDefinition = /*#__PURE__*/function () {
  ...
  _proto3.initializeFromFields = function initializeFromFields() {
    if (this.type === exports.DocumentType.JAVA) {
  ...
  _createClass(DocumentDefinition, [{
    ...
    set: function set(type) {
      this._type = type;
      this.isPropertyOrConstant = type === exports.DocumentType.CONSTANT || type === exports.DocumentType.PROPERTY;
    }
  }]);
...
var ConfigModel = /*#__PURE__*/function () {
  ...
  _proto.initializePropertyDoc = function initializePropertyDoc(propertyDoc, isSource) {
    ...
    propertyDoc.type = exports.DocumentType.PROPERTY;
    propertyDoc.name = exports.DocumentDefaultName.PROPERTIES;
  ...
  _proto.setConstantPropertyDocs = function setConstantPropertyDocs() {
    ...
    this.constantDoc.type = exports.DocumentType.CONSTANT;
    this.constantDoc.name = exports.DocumentDefaultName.CONSTANTS;
  ...
  _proto.addDocument = function addDocument(docInitModel) {
    ...
    if (docDef.type === exports.DocumentType.XSD) {
      docDef.uri = 'atlas:xml:' + docDef.id;
    } else if (docDef.type === exports.DocumentType.JAVA) {
      docDef.uri = "atlas:java:" + docDef.id + "?className=" + docDef.inspectionSource;

      if (docInitModel.collectionType && docInitModel.collectionType !== exports.CollectionType.NONE) {
  ...
  _proto.hasJavaDocuments = function hasJavaDocuments() {
    for (var _iterator2 = _createForOfIteratorHelperLoose(this.getAllDocs()), _step2; !(_step2 = _iterator2()).done;) {
      ...
      if (doc.type === exports.DocumentType.JAVA) {
        return true;
      }
    }
  ...
  _proto.getFirstXmlDoc = function getFirstXmlDoc(isSource) {
    ...
    return docs.find(function (doc) {
      return doc.type === exports.DocumentType.XML;
    });
  };
...
})(exports.ErrorScope || (exports.ErrorScope = {}));
...
var ExpressionModel = /*#__PURE__*/function () {
  function ExpressionModel(mapping, cfg) {
    ...
    this.cfg = cfg;
    this.expressionHTML = '';
    this.expressionUpdatedSource = new rxjs.Subject();
    ...
    while (text.search(/\$\{[a-zA-Z0-9.:/<>[\]_-]+\}/) !== -1) {
      ...
      if (!fn || !fn.mappedField) {
        this.cfg.errorService.addError(new ErrorInfo({
          ...
          level: exports.ErrorLevel.ERROR,
          scope: exports.ErrorScope.MAPPING,
...
var FieldActionArgument = function FieldActionArgument() {
  this.type = exports.FieldType.STRING;
  this.values = null;
  this.serviceObject = {};
};
...
var FieldActionDefinition = /*#__PURE__*/function () {
  function FieldActionDefinition() {
    this.arguments = [];
    this.sourceType = exports.FieldType.NONE;
    this.targetType = exports.FieldType.NONE;
    this.multiplicity = exports.Multiplicity.ONE_TO_ONE;
    this.serviceObject = {};
  }
  ...
  _proto.parseFieldFromDocument = function parseFieldFromDocument(field, parentField) {
    if (field != null && field.status === 'NOT_FOUND') {
      this.cfg.errorService.addError(new ErrorInfo({
        ...
        level: exports.ErrorLevel.WARN,
        scope: exports.ErrorScope.APPLICATION,
        type: exports.ErrorType.USER
      }));
      return null;
...
var CsvInspectionModel = /*#__PURE__*/function (_DocumentInspectionMo) {
  ...
  _proto.parseCSVFieldFromDocument = function parseCSVFieldFromDocument(field, parentField) {
    ...
    if (field.fieldType !== exports.FieldType.COMPLEX) {
      return;
    }
...
var JavaInspectionModel = /*#__PURE__*/function (_DocumentInspectionMo) {
  ...
  _proto.parseResponse = function parseResponse(responseJson) {
    ...
    if (javaClass.collectionType && javaClass.collectionType !== exports.CollectionType.NONE.valueOf()) {
...
var JavaInspectionRequestOptions = /*#__PURE__*/function (_DocumentInspectionRe2) {
  ...
  function JavaInspectionRequestOptions(cfg, doc) {
    ...
    if (_this3.doc.initModel.collectionType && _this3.doc.initModel.collectionType !== exports.CollectionType.NONE) {
...
var LookupTableEntry = function LookupTableEntry() {
  this.sourceType = exports.FieldType.STRING;
  this.targetType = exports.FieldType.STRING;
};
...
var TransitionDelimiterModel = function TransitionDelimiterModel(delimiter, serializedValue, prettyName, actualDelimiter) {
  this.delimiter = exports.TransitionDelimiter.SPACE;
...
var TransitionModel = /*#__PURE__*/function () {
  function TransitionModel() {
    this.mode = exports.TransitionMode.ONE_TO_ONE;
    this.delimiter = exports.TransitionDelimiter.SPACE;
    this.userDelimiter = '';
  ...
  TransitionModel.initialize = function initialize() {
    if (TransitionModel.delimiterModels.length === 0) {
      var models = [];
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.NONE, null, '[None]', ''));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.AMPERSAND, 'Ampersand', 'Ampersand [&]', '&'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.AT_SIGN, 'AtSign', 'At Sign [@]', '@'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.BACKSLASH, 'Backslash', 'Backslash [\\]', '\\'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.COLON, 'Colon', 'Colon [:]', ':'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.COMMA, 'Comma', 'Comma [,]', ','));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.DASH, 'Dash', 'Dash [-]', '-'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.EQUAL, 'Equal', 'Equal [=]', '='));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.HASH, 'Hash', 'Hash [#]', '#'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.PERIOD, 'Period', 'Period [.]', '.'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.PIPE, 'Pipe', 'Pipe [|]', '|'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.SEMICOLON, 'Semicolon', 'Semicolon [;]', ';'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.SLASH, 'Slash', 'Slash [/]', '/'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.SPACE, 'Space', 'Space [ ]', ' '));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.UNDERSCORE, 'Underscore', 'Underscore [_]', '_'));
      models.push(new TransitionDelimiterModel(exports.TransitionDelimiter.USER_DEFINED, 'User defined', 'User defined', '\0'));
  ...
  TransitionModel.getMappingModeName = function getMappingModeName(mode) {
    ...
    switch (mode) {
      case exports.TransitionMode.ONE_TO_ONE:
        {
          actionName = 'One to One';
          break;
        }

      case exports.TransitionMode.MANY_TO_ONE:
        {
          actionName = 'Many to One';
          break;
        }

      case exports.TransitionMode.ONE_TO_MANY:
        {
          actionName = 'One to Many';
          break;
        }

      case exports.TransitionMode.ENUM:
        {
          actionName = 'ENUM';
          break;
        }

      case exports.TransitionMode.FOR_EACH:
        {
          actionName = 'For Each';
          break;
        }

      case exports.TransitionMode.EXPRESSION:
        {
  ...
  _proto.getPrettyName = function getPrettyName() {
    ...
    if (this.mode === exports.TransitionMode.ONE_TO_MANY || this.mode === exports.TransitionMode.MANY_TO_ONE) {
      return TransitionModel.getMappingModeName(this.mode) + transitionFieldActionName;
    } else if (this.mode === exports.TransitionMode.ENUM) {
      return 'Enum (table: ' + this.lookupTableName + ')';
    } else if (this.mode === exports.TransitionMode.EXPRESSION) {
  ...
  _proto.isOneToManyMode = function isOneToManyMode() {
    return this.mode === exports.TransitionMode.ONE_TO_MANY;
  };

  _proto.isOneToOneMode = function isOneToOneMode() {
    return this.mode === exports.TransitionMode.ONE_TO_ONE;
  };

  _proto.isManyToOneMode = function isManyToOneMode() {
    return this.mode === exports.TransitionMode.MANY_TO_ONE;
  };

  _proto.isForEachMode = function isForEachMode() {
    return this.mode === exports.TransitionMode.FOR_EACH;
  };

  _proto.isEnumerationMode = function isEnumerationMode() {
    return this.mode === exports.TransitionMode.ENUM;
  };

  _proto.isExpressionMode = function isExpressionMode() {
    return this.mode === exports.TransitionMode.EXPRESSION;
  };
...
var MappingDefinition = /*#__PURE__*/function () {
  ...
  _proto.removeMapping = function removeMapping(m) {
    if (m.transition.mode === exports.TransitionMode.ENUM) {
...
var MappingModel = /*#__PURE__*/function () {
  ...
  _proto2.getReferenceField = function getReferenceField(docId, fieldPath) {
    ...
    if ((field === null || field === void 0 ? void 0 : field.type) === exports.FieldType.COMPLEX) {
...
var DocumentInspectionUtil = /*#__PURE__*/function () {
  ...
  DocumentInspectionUtil.fromDocumentDefinition = function fromDocumentDefinition(cfg, doc) {
    switch (doc.type) {
      case exports.DocumentType.JAVA:
        return new JavaInspectionModel(cfg, doc);

      case exports.DocumentType.JSON:
        return new JsonInspectionModel(cfg, doc);

      case exports.DocumentType.XSD:
      case exports.DocumentType.XML:
        return new XmlInspectionModel(cfg, doc);

      case exports.DocumentType.CSV:
  ...
  DocumentInspectionUtil.fromJavaProperties = function fromJavaProperties(cfg, className, isSource, collectionType, collectionClassName) {
    if (collectionType === void 0) {
      collectionType = exports.CollectionType.NONE;
    }
    ...
    model.type = exports.DocumentType.JAVA;
    model.inspectionType = exports.InspectionType.JAVA_CLASS;
    ...
    if (collectionType && collectionType !== exports.CollectionType.NONE) {
...
var LookupTableUtil = /*#__PURE__*/function () {
  ...
  LookupTableUtil.populateMappingLookupTable = function populateMappingLookupTable(mappingDefinition, m) {
    if (!(m.transition.mode === exports.TransitionMode.ENUM && !m.transition.lookupTableName && m.getFields(true).length === 1 && m.getFields(false).length === 1)) {
      return;
    }
...
var MappingSerializer = /*#__PURE__*/function () {
  ...
  MappingSerializer.serializeFieldMapping = function serializeFieldMapping(cfg, mapping, id, ignoreValue) {
    ...
    if (mapping.transition.isEnumerationMode()) {
      jsonMapping.mappingType = exports.MappingType.LOOKUP;
      /* @deprecated */
  ...
  MappingSerializer.deserializeFieldMapping = function deserializeFieldMapping(mappingJson, cfg) {
    ...
    mapping.transition.mode = exports.TransitionMode.ONE_TO_ONE;
    var isLookupMapping = mappingJson.mappingType === 'LOOKUP' || mappingJson.lookupTableName != null;

    if (mappingJson.mappingType && mappingJson.mappingType !== exports.MappingType.NONE) {
    ...
    if (mappingJson.inputFieldGroup) {
      ...
      if ((_mappingJson$outputFi = mappingJson.outputField) !== null && _mappingJson$outputFi !== void 0 && _mappingJson$outputFi.length && mappingJson.outputField.length > 1) {
        mapping.transition.mode = exports.TransitionMode.ONE_TO_MANY;
      }
    ...
    if (mappingJson.expression && mappingJson.expression.length > 0) {
      ...
      mapping.transition.mode = exports.TransitionMode.EXPRESSION;
    ...
    if (isLookupMapping) {
      ...
      mapping.transition.mode = exports.TransitionMode.ENUM;
    }
  ...
  MappingSerializer.deserializeInputFieldGroup = function deserializeInputFieldGroup(mappingJson, mapping, cfg) {
    ...
    if (mappingJson.expression && mappingJson.inputFieldGroup.fieldType === exports.FieldType.COMPLEX) {
      mapping.transition.expression.hasComplexField = true;
    }

    mapping.transition.mode = exports.TransitionMode.MANY_TO_ONE;
    ...
    if (mappingJson.inputFieldGroup.actions && (_mappingJson$inputFie = mappingJson.inputFieldGroup.actions[0]) !== null && _mappingJson$inputFie !== void 0 && _mappingJson$inputFie.delimiter) {
      ...
      if (firstAction) {
        ...
        if (firstAction.Expression || firstAction['@type'] === 'Expression') {
          ...
          parsedAction.definition = cfg.fieldActionService.getActionDefinitionForName(parsedAction.name, exports.Multiplicity.MANY_TO_ONE);
  ...
  MappingSerializer.deserializeAudits = function deserializeAudits(audits, errorType) {
    ...
    for (var _iterator9 = _createForOfIteratorHelperLoose(audits.audit), _step9; !(_step9 = _iterator9()).done;) {
      ...
      errors.push(new ErrorInfo({
        message: msg,
        level: exports.ErrorLevel[audit.status],
        scope: exports.ErrorScope.MAPPING,
        type: errorType,
        object: audit.value
      }));
  ...
  MappingSerializer.createInputFieldGroup = function createInputFieldGroup(field, isComplex, docId, path) {
    ...
    if (isComplex) {
      inputFieldGroup.fieldType = exports.FieldType.COMPLEX;
    }
  ...
  MappingSerializer.serializeDocuments = function serializeDocuments(docs, mappingDefinition) {
    ...
    for (var _iterator10 = _createForOfIteratorHelperLoose(docs), _step10; !(_step10 = _iterator10()).done;) {
      ...
      var serializedDoc = {
        ...
        uri: doc.uri,
        dataSourceType: doc.isSource ? exports.DataSourceType.SOURCE : exports.DataSourceType.TARGET
      };
      ...
      if (doc.type === exports.DocumentType.XML || doc.type === exports.DocumentType.XSD) {
      ...
      } else if (doc.type === exports.DocumentType.JSON) {
  ...
  MappingSerializer.serializeProperties = function serializeProperties(docDef) {
    ...
    for (var _iterator13 = _createForOfIteratorHelperLoose(docDef.fields), _step13; !(_step13 = _iterator13()).done;) {
      ...
      propertyDescriptions.push({
        ...
        fieldType: field.type,
        scope: field.scope,
        dataSourceType: docDef.isSource ? exports.DataSourceType.SOURCE : exports.DataSourceType.TARGET
      });
    }
  ...
  MappingSerializer.serializeFields = function serializeFields(mapping, isSource, cfg, ignoreValue) {
    ...
    for (var _iterator17 = _createForOfIteratorHelperLoose(fields), _step17; !(_step17 = _iterator17()).done;) {
      ...
      if (field.docDef.type === exports.DocumentType.XML || field.docDef.type === exports.DocumentType.XSD) {
        serializedField.userCreated = field.userCreated;
      } else if (field.docDef.type === exports.DocumentType.JAVA && !field.isPrimitive) {
      ...
      if (field.isProperty()) {
        ...
        if (field.docDef.type === exports.DocumentType.JSON) {
          serializedField.jsonType = JSON_ENUM_FIELD_JSON_TYPE;
        } else if (field.docDef.type === exports.DocumentType.XML || field.docDef.type === exports.DocumentType.XSD) {
      ...
      if (field.docDef.type === exports.DocumentType.CSV) {
  ...
  MappingSerializer.deserializeFieldMappingFromType = function deserializeFieldMappingFromType(mapping, fieldMapping, cfg) {
    if (fieldMapping.mappingType === 'SEPARATE') {
      mapping.transition.mode = exports.TransitionMode.ONE_TO_MANY;
      mapping.transition.transitionFieldAction = FieldAction.create(cfg.fieldActionService.getActionDefinitionForName('Split', exports.Multiplicity.ONE_TO_MANY)); // TODO: check this non null operator
      ...
      mapping.transition.mode = exports.TransitionMode.MANY_TO_ONE;
      mapping.transition.transitionFieldAction = FieldAction.create(cfg.fieldActionService.getActionDefinitionForName('Concatenate', exports.Multiplicity.MANY_TO_ONE)); // TODO: check this non null operator
  ...
  MappingSerializer.deserializeProperties = function deserializeProperties(cfg, jsonMapping, isSource) {
    ...
    for (var _iterator26 = _createForOfIteratorHelperLoose(jsonMapping.AtlasMapping.properties.property), _step26; !(_step26 = _iterator26()).done;) {
      ...
      if (isSource && property.dataSourceType === exports.DataSourceType.TARGET || !isSource && property.dataSourceType !== exports.DataSourceType.TARGET) {
        continue;
      }
  ...
  MappingSerializer.deserializeFieldActions = function deserializeFieldActions(field, mappedField, mapping, cfg, isSource) {
    ...
    for (var _iterator29 = _createForOfIteratorHelperLoose(field.actions), _step29; !(_step29 = _iterator29()).done;) {
      ...
      if (action.name === 'CustomAction') {
        parsedAction.definition = cfg.fieldActionService.getActionDefinitionForName(action.argumentValues[0].value, exports.Multiplicity.ONE_TO_ONE);
      } else {
      ...
      if (isSource && (action.Expression || action['@type'] === 'Expression')) {
        ...
        mapping.transition.expression.insertText(expr);
      } else if (isSource && parsedAction.definition && [exports.Multiplicity.ONE_TO_MANY, exports.Multiplicity.MANY_TO_ONE].includes(parsedAction.definition.multiplicity)) {
        if (mapping.transition.transitionFieldAction) {
...
var DocumentManagementService = /*#__PURE__*/function () {
    ...
    return new Promise(function (resolve) {
      try {
        ...
        var _temp3 = function _temp3(_result) {
          ...
          _this5.addNonJavaDocument(fileText, userFile + '-' + Guid.newGuid(), userFile, docType, isSchema ? exports.InspectionType.SCHEMA : exports.InspectionType.INSTANCE, isSource, inspectionParameters).then(function (value) {
            if (!value) {
              resolve(false);
              return;
            }
  ...
  _proto.addDocument = function addDocument(docBody, docId, docName, docType, inspectionType, isSource, parameters) {
    if (docType === exports.DocumentType.JAVA) {
  ...
  _proto.createConstant = function createConstant(constName, constValue, constType, addToActiveMapping) {
    ...
    field.type = exports.FieldType[constType];
  ...
  _proto.createProperty = function createProperty(propName, propType, propScope, isSource, addToActiveMapping) {
    ...
    field.name = propName;
    field.type = exports.FieldType[propType];
...
var ErrorHandlerService = /*#__PURE__*/function () {
  function ErrorHandlerService() {
    this.errors = [];
    this.formErrors = [];
    this.errorUpdatedSource = new rxjs.Subject();
  }
  /**
  ...
  _proto.addError = function addError() {
    ...
    errors.forEach(function (error) {
      ...
      var store = exports.ErrorScope.FORM === error.scope ? _this.formErrors : _this.errors;
  ...
  _proto.removeError = function removeError(identifier, scope) {
    if (scope === exports.ErrorScope.FORM && this.formErrorUpdatedSource && !this.formErrorUpdatedSource.closed) {
  ...
  _proto.clearPreviewErrors = function clearPreviewErrors() {
    this.errors = this.errors.filter(function (e) {
      return e.type !== exports.ErrorType.PREVIEW;
    });
    this.emitUpdatedEvent();
  }
  /**
  ...
  _proto.clearValidationErrors = function clearValidationErrors(mapping) {
    this.errors = this.errors.filter(function (e) {
      return e.type !== exports.ErrorType.VALIDATION && (!mapping || !e.mapping || e.mapping !== mapping);
    });
    this.emitUpdatedEvent();
  }
  /**
  ...
  _proto.clearFieldErrors = function clearFieldErrors() {
    this.errors = this.errors.filter(function (e) {
      return e.scope !== exports.ErrorScope.FIELD;
    });
    this.emitUpdatedEvent();
  }
  /**
  ...
  _proto.clearFormErrors = function clearFormErrors() {
    this.formErrors = [];
    this.emitUpdatedEvent(exports.ErrorScope.FORM);
  }
  /**
  ...
  _proto.createFormErrorChannel = function createFormErrorChannel() {
    ...
    this.formErrors = [];
    this.formErrorUpdatedSource = new rxjs.Subject();
  ...
  _proto.emitUpdatedEvent = function emitUpdatedEvent(scope) {
    if (exports.ErrorScope.FORM === scope) {
      if (this.formErrorUpdatedSource && !this.formErrorUpdatedSource.closed) {
...
var FieldActionService = /*#__PURE__*/function () {
  function FieldActionService(api) {
    ...
    this.api = api;
    this.cfg = ConfigModel.getConfig();
    this.actions = (_this$actions = {}, _this$actions[exports.Multiplicity.ONE_TO_ONE] = [], _this$actions[exports.Multiplicity.ONE_TO_MANY] = [], _this$actions[exports.Multiplicity.MANY_TO_ONE] = [], _this$actions[exports.Multiplicity.ZERO_TO_ONE] = [], _this$actions[exports.Multiplicity.MANY_TO_MANY] = [], _this$actions);
  ...
  _proto.getActionsAppliesToField = function getActionsAppliesToField(mapping, isSource, multiplicity) {
    ...
    if (multiplicity === void 0) {
      multiplicity = exports.Multiplicity.ONE_TO_ONE;
    }
  ...
  _proto.extractFieldActionDefinition = function extractFieldActionDefinition(actionDetail) {
    ...
    if (actionDetail.actionSchema) {
      for (var _i = 0, _Object$keys = Object.keys(actionDetail.actionSchema.properties); _i < _Object$keys.length; _i++) {
        ...
        var argType = argTypeString ? exports.FieldType[argTypeString] : exports.FieldType.STRING;
  ...
  _proto.appliesToTargetField = function appliesToTargetField(action, _, selectedTargetField) {
    ...
    if (action.multiplicity !== exports.Multiplicity.ONE_TO_ONE) {
      return false;
    } // Check for matching types - date.
  ...
  _proto.clearActionDefinitions = function clearActionDefinitions() {
    ...
    Object.keys(exports.Multiplicity).forEach(function (m) {
...
var FileManagementService = /*#__PURE__*/function () {
  ...
  _proto.getCurrentMappingDigest = function getCurrentMappingDigest() {
    ...
    return new Promise(function (resolve, reject) {
      _this2.getCurrentFile(exports.FileName.DIGEST, exports.FileType.DIGEST).then(function (gzipped) {
        if (!gzipped) {
          resolve(null);
          return;
        }

        var gunzipped = pako.inflate(gzipped);
  ...
  _proto.getCurrentADMArchive = function getCurrentADMArchive() {
    return this.getCurrentFile(exports.FileName.ADM, exports.FileType.ADM);
  };
  ...
  _proto.setMappingDigestToService = function setMappingDigestToService(mappingDigest) {
    ...
    return new Promise(function (resolve) {
      ...
      try {
        compressedBuffer = pako.gzip(binBuffer);
      } catch (error1) {
      ...
      _this8.setBinaryFileToService(fileContent, url, exports.FileName.DIGEST).then(function (value) {
        resolve(value);
      });
    });
  };
  ...
  _proto.setADMArchiveFileToService = function setADMArchiveFileToService(compressedBuffer) {
    ...
    return this.setBinaryFileToService(fileContent, url, exports.FileName.ADM);
  }
  /**
  ...
  _proto.importJarFile = function importJarFile(binaryBuffer) {
    ...
    return new Promise(function (resolve) {
      try {
        ...
        return Promise.resolve(_this10.setBinaryFileToService(fileContent, url, exports.FileName.JAR)).then(function (jarUpdated) {
          var _temp = function () {
...
var MappingExpressionService = /*#__PURE__*/function () {
  ...
  _proto.toggleExpressionMode = function toggleExpressionMode() {
    ...
    if (activeMapping.transition.mode === exports.TransitionMode.ONE_TO_MANY) {
      this.cfg.errorService.addError(new ErrorInfo({
    ...
    if (activeMapping.transition.enableExpression) {
      activeMapping.transition.mode = exports.TransitionMode.EXPRESSION;
      ...
      activeMapping.transition.mode = exports.TransitionMode.ONE_TO_ONE;
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(configModel.getDocs(isSource)), _step; !(_step = _iterator()).done;) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(fields), _step2; !(_step2 = _iterator2()).done;) {
        ...
        if (filter == null || filter === '' || displayName.toLowerCase().indexOf(filter.toLowerCase()) !== -1) {
          if (!configModel.mappingService.isFieldSelectable(activeMapping, field) && field.type !== exports.FieldType.COMPLEX) {
            continue;
          }
  ...
  _proto.createMappingExpression = function createMappingExpression(mapping) {
    ...
    if (sourceMappedFields.length > 1 || sourceMappedCollection && ((_mapping$transition$t = mapping.transition.transitionFieldAction) === null || _mapping$transition$t === void 0 ? void 0 : (_mapping$transition$t2 = _mapping$transition$t.definition) === null || _mapping$transition$t2 === void 0 ? void 0 : _mapping$transition$t2.multiplicity) === exports.Multiplicity.MANY_TO_ONE) {
      expr = 'Concatenate (';
...
var MappingManagementService = /*#__PURE__*/function () {
  function MappingManagementService(api) {
    this.api = api;
    this.lineRefreshSource = new rxjs.Subject();
    this.lineRefresh$ = this.lineRefreshSource.asObservable();
    this.mappingUpdatedSource = new rxjs.Subject();
    this.mappingUpdated$ = this.mappingUpdatedSource.asObservable();
    this.mappingSelectionRequiredSource = new rxjs.Subject();
  ...
  _proto.processValidationResponse = function processValidationResponse(body, resolve) {
    ...
    if (body && body.Validations && body.Validations.validation) {
      var _loop = function _loop() {
        ...
        var level = exports.ErrorLevel[validation.status ? validation.status : 'ERROR'];
        var scope = exports.ErrorScope[validation.scope ? validation.scope : 'MAPPING'];
        var validatedMapping = undefined;

        if (!scope || scope !== exports.ErrorScope.MAPPING || !validation.id) {
          scope = exports.ErrorScope.APPLICATION;
        } else {
          scope = exports.ErrorScope.MAPPING;
        ...
        errors.push(new ErrorInfo({
          ...
          type: exports.ErrorType.VALIDATION
        }));
      };
  ...
  _proto.updateTransition = function updateTransition(mapping) {
    ...
    if (sourceMappedCollection && targetMappedCollection) {
      mapping.transition.mode = exports.TransitionMode.FOR_EACH;
      return;
    }
    ...
    if (sourceMappedFields.length > 1 || sourceMappedCollection) {
      ...
      if (!mapping.transition.transitionFieldAction || !mapping.transition.transitionFieldAction.definition || mapping.transition.transitionFieldAction.definition.multiplicity !== exports.Multiplicity.MANY_TO_ONE) {
        mapping.transition.transitionFieldAction = FieldAction.create(this.cfg.fieldActionService.getActionDefinitionForName('Concatenate', exports.Multiplicity.MANY_TO_ONE)); // TODO: check this non null operator
    ...
    if (targetMappedFields.length > 1 || targetMappedCollection) {
      ...
      if (!mapping.transition.transitionFieldAction || ((_mapping$transition$t = mapping.transition.transitionFieldAction.definition) === null || _mapping$transition$t === void 0 ? void 0 : _mapping$transition$t.multiplicity) !== exports.Multiplicity.ONE_TO_MANY) {
        mapping.transition.transitionFieldAction = FieldAction.create(this.cfg.fieldActionService.getActionDefinitionForName('Split', exports.Multiplicity.ONE_TO_MANY)); // TODO: check this non null operator
  ...
  _proto.isEnumerationMapping = function isEnumerationMapping(mapping) {
    return mapping.transition.mode === exports.TransitionMode.ENUM;
  };
...
var MappingPreviewService = /*#__PURE__*/function () {
  function MappingPreviewService(api) {
    this.api = api;
    this.mappingPreviewInputSource = new rxjs.Subject();
    this.mappingPreviewInput$ = this.mappingPreviewInputSource.asObservable();
    this.mappingPreviewOutputSource = new rxjs.Subject();
    this.mappingPreviewOutput$ = this.mappingPreviewOutputSource.asObservable();
    this.mappingPreviewErrorSource = new rxjs.Subject();
      ...
      _this.api.put(url, {
        ...
        if (_this.cfg.mappings && _this.cfg.mappings.activeMapping && _this.cfg.mappings.activeMapping === inputFieldMapping) {
          _this.cfg.errorService.addError(new ErrorInfo({
            ...
            scope: exports.ErrorScope.MAPPING,
            type: exports.ErrorType.PREVIEW
          }));
        }
  ...
  _proto.processPreviewResponse = function processPreviewResponse(inputFieldMapping, body) {
    ...
    var audits = MappingSerializer.deserializeAudits(body.ProcessMappingResponse.audits, exports.ErrorType.PREVIEW); // TODO: check this non null operator
...
var InitializationService = /*#__PURE__*/function () {
  function InitializationService(api) {
    this.api = api;
    this.cfg = ConfigModel.getConfig();
    this.systemInitializedSource = new rxjs.Subject();
    this.systemInitialized$ = this.systemInitializedSource.asObservable();
    this.initializationStatusChangedSource = new rxjs.Subject();
...
exports.ATLAS_MAPPING_JSON_TYPE = ATLAS_MAPPING_JSON_TYPE;
exports.COLLECTION_JSON_TYPE = COLLECTION_JSON_TYPE;
exports.CONSTANT_FIELD_JSON_TYPE = CONSTANT_FIELD_JSON_TYPE;
exports.CommonUtil = CommonUtil;
exports.ConfigModel = ConfigModel;
exports.CsvInspectionModel = CsvInspectionModel;
exports.CsvInspectionRequestModel = CsvInspectionRequestModel;
exports.CsvInspectionRequestOptions = CsvInspectionRequestOptions;
exports.DATA_SOURCE_JSON_TYPE = DATA_SOURCE_JSON_TYPE;
exports.DataMapperInitializationModel = DataMapperInitializationModel;
exports.DocumentDefinition = DocumentDefinition;
exports.DocumentInitializationModel = DocumentInitializationModel;
exports.DocumentInspectionModel = DocumentInspectionModel;
exports.DocumentInspectionRequestModel = DocumentInspectionRequestModel;
exports.DocumentInspectionRequestOptions = DocumentInspectionRequestOptions;
exports.DocumentInspectionUtil = DocumentInspectionUtil;
...
exports.ExpressionUpdatedEvent = ExpressionUpdatedEvent;
exports.FIELD_GROUP_JSON_TYPE = FIELD_GROUP_JSON_TYPE;
exports.FIELD_PATH_SEPARATOR = FIELD_PATH_SEPARATOR;
exports.Field = Field;
exports.FieldAction = FieldAction;
exports.FieldActionArgument = FieldActionArgument;
exports.FieldActionArgumentValue = FieldActionArgumentValue;
exports.FieldActionDefinition = FieldActionDefinition;
exports.FieldActionService = FieldActionService;
exports.FieldNode = FieldNode;
exports.FileManagementService = FileManagementService;
exports.Guid = Guid;
exports.HTTP_STATUS_NO_CONTENT = HTTP_STATUS_NO_CONTENT;
exports.HTTP_STATUS_OK = HTTP_STATUS_OK;
exports.InitializationService = InitializationService;
exports.JAVA_CLASS_JSON_TYPE = JAVA_CLASS_JSON_TYPE;
exports.JAVA_ENUM_FIELD_JSON_TYPE = JAVA_ENUM_FIELD_JSON_TYPE;
exports.JAVA_INSPECTION_REQUEST_JSON_TYPE = JAVA_INSPECTION_REQUEST_JSON_TYPE;
exports.JAVA_MODEL_PACKAGE_PREFIX = JAVA_MODEL_PACKAGE_PREFIX;
exports.JSON_DATA_SOURCE_JSON_TYPE = JSON_DATA_SOURCE_JSON_TYPE;
exports.JSON_ENUM_FIELD_JSON_TYPE = JSON_ENUM_FIELD_JSON_TYPE;
exports.JSON_INSPECTION_REQUEST_JSON_TYPE = JSON_INSPECTION_REQUEST_JSON_TYPE;
exports.JSON_MODEL_PACKAGE_PREFIX = JSON_MODEL_PACKAGE_PREFIX;
exports.JavaInspectionModel = JavaInspectionModel;
exports.JavaInspectionRequestModel = JavaInspectionRequestModel;
exports.JavaInspectionRequestOptions = JavaInspectionRequestOptions;
exports.JsonInspectionModel = JsonInspectionModel;
exports.JsonInspectionRequestModel = JsonInspectionRequestModel;
exports.JsonInspectionRequestOptions = JsonInspectionRequestOptions;
exports.LookupTable = LookupTable;
exports.LookupTableData = LookupTableData;
exports.LookupTableEntry = LookupTableEntry;
exports.LookupTableUtil = LookupTableUtil;
exports.MAPPING_JSON_TYPE = MAPPING_JSON_TYPE;
exports.MODEL_PACKAGE_PREFIX = MODEL_PACKAGE_PREFIX;
exports.MappedField = MappedField;
exports.MappingDefinition = MappingDefinition;
exports.MappingDigestUtil = MappingDigestUtil;
exports.MappingExpressionService = MappingExpressionService;
...
exports.PROCESS_MAPPING_REQUEST_JSON_TYPE = PROCESS_MAPPING_REQUEST_JSON_TYPE;
exports.PROPERTY_FIELD_JSON_TYPE = PROPERTY_FIELD_JSON_TYPE;
exports.PaddingField = PaddingField;
exports.TextNode = TextNode;
exports.TransitionDelimiterModel = TransitionDelimiterModel;
exports.TransitionModel = TransitionModel;
exports.XML_DATA_SOURCE_JSON_TYPE = XML_DATA_SOURCE_JSON_TYPE;
exports.XML_ENUM_FIELD_JSON_TYPE = XML_ENUM_FIELD_JSON_TYPE;
exports.XML_INSPECTION_REQUEST_JSON_TYPE = XML_INSPECTION_REQUEST_JSON_TYPE;
exports.XML_MODEL_PACKAGE_PREFIX = XML_MODEL_PACKAGE_PREFIX;
exports.XmlInspectionModel = XmlInspectionModel;
exports.XmlInspectionRequestModel = XmlInspectionRequestModel;
exports.XmlInspectionRequestOptions = XmlInspectionRequestOptions;
exports.collectionTypes = collectionTypes;
exports.constantTypes = constantTypes;
exports.getCsvParameterOptions = getCsvParameterOptions;
