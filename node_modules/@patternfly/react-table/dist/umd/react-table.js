(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    class DropdownWithContext extends React__namespace.Component {
        ...
        render() {
            const _a = this.props, { children, className, direction, dropdownItems, isOpen, isPlain, isGrouped, isFullHeight, 
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            onSelect, position, toggle, autoFocus, menuAppendTo } = _a, props = __rest$1(_a, ["children", "className", "direction", "dropdownItems", "isOpen", "isPlain", "isGrouped", "isFullHeight", "onSelect", "position", "toggle", "autoFocus", "menuAppendTo"]);
    ...
    class Toggle extends React__namespace.Component {
        ...
        render() {
            ...
            /* eslint-enable @typescript-eslint/no-unused-vars */
            id, type } = _a, props = __rest$1(_a, ["className", "children", "isOpen", "isDisabled", "isPlain", "isPrimary", "isSplitButton", "toggleVariant", "onToggle", 'aria-haspopup', "isActive", "bubbleEvent", "onEnter", "parentRef", "getMenuRef", "id", "type"]);
            return (React__namespace.createElement(DropdownContext.Consumer, null, ({ toggleClass }) => (React__namespace.createElement("button", Object.assign({}, props, { id: id, ref: this.buttonRef, className: css(isSplitButton ? _default$e.dropdownToggleButton : toggleClass || _default$e.dropdownToggle, isActive && _default$e.modifiers.active, isPlain && _default$e.modifiers.plain, isPrimary && _default$e.modifiers.primary, buttonVariantStyles[toggleVariant], className), type: type || 'button', onClick: event => onToggle(!isOpen, event), "aria-expanded": isOpen, "aria-haspopup": ariaHasPopup, onKeyDown: event => this.onKeyDown(event), disabled: isDisabled }), children))));
        }
    }
    ...
    class SelectOption extends React__namespace.Component {
        ...
        render() {
            ...
            // eslint-disable-next-line no-console
            isLastOptionBeforeFooter } = _a, props = __rest$1(_a, ["children", "className", "id", "description", "itemCount", "value", "onClick", "isDisabled", "isPlaceholder", "isNoResultsOption", "isSelected", "isChecked", "isFocused", "sendRef", "keyHandler", "index", "component", "inputId", "isFavorite", "ariaIsFavoriteLabel", "ariaIsNotFavoriteLabel", "isLoad", "isLoading", "setViewMoreNextIndex", "isLastOptionBeforeFooter"]);
            /* eslint-enable @typescript-eslint/no-unused-vars */
            const Component = component;
            ...
            return (React__namespace.createElement(SelectConsumer, null, ({ onSelect, onClose, variant, inputIdPrefix, onFavorite }) => (React__namespace.createElement(React__namespace.Fragment, null,
                variant !== SelectVariant.checkbox && (React__namespace.createElement("li", { id: generatedId, role: "presentation", className: css(isLoading && _default$b.selectListItem, !isLoad && !isLoading && _default$b.selectMenuWrapper, isFavorite && _default$b.modifiers.favorite, isFocused && _default$b.modifiers.focus, isLoading && _default$b.modifiers.loading), ref: this.liRef },
                    isLoading && children,
                ...
                variant === SelectVariant.checkbox && isLoad && (React__namespace.createElement("button", { className: css(_default$b.selectMenuItem, _default$b.modifiers.load, isFocused && _default$b.modifiers.focus, className), onKeyDown: (event) => {
                        this.onKeyDown(event, 0, undefined, true);
                    }, onClick: (event) => {
                        onViewMoreClick(event);
                        event.stopPropagation();
                    }, ref: this.ref }, children || (value && value.toString && value.toString()))),
                variant === SelectVariant.checkbox && isLoading && (React__namespace.createElement("div", { className: css(_default$b.selectListItem, isLoading && _default$b.modifiers.loading, className) }, children)),
                variant === SelectVariant.checkbox && !isNoResultsOption && !isLoading && !isLoad && (React__namespace.createElement("label", Object.assign({}, props, { className: css(_default$9.check, _default$b.selectMenuItem, isDisabled && _default$b.modifiers.disabled, description && _default$b.modifiers.description, className), onKeyDown: (event) => {
                        this.onKeyDown(event, 0, undefined, true);
                    } }),
                ...
                variant === SelectVariant.checkbox && isNoResultsOption && !isLoading && !isLoad && (React__namespace.createElement("div", null,
    ...
    class SelectToggle extends React__namespace.Component {
        ...
        render() {
            /* eslint-disable @typescript-eslint/no-unused-vars */
            const _a = this.props, { className, children, isOpen, isActive, isPlain, isDisabled, hasPlaceholderStyle, variant, onToggle, onEnter, onClose, onClickTypeaheadToggleButton, handleTypeaheadKeys, parentRef, menuRef, id, type, hasClearButton, 'aria-labelledby': ariaLabelledBy, 'aria-label': ariaLabel, hasFooter, footerRef } = _a, props = __rest$1(_a, ["className", "children", "isOpen", "isActive", "isPlain", "isDisabled", "hasPlaceholderStyle", "variant", "onToggle", "onEnter", "onClose", "onClickTypeaheadToggleButton", "handleTypeaheadKeys", "parentRef", "menuRef", "id", "type", "hasClearButton", 'aria-labelledby', 'aria-label', "hasFooter", "footerRef"]);
            /* eslint-enable @typescript-eslint/no-unused-vars */
    ...
    const cellActions = (actions, actionResolver, areActionsDisabled) => (label, { rowData, column, rowIndex, columnIndex, column: { extraParams: { dropdownPosition, dropdownDirection, actionsToggle } }, property }) => {
        ...
        const renderProps = resolvedActions && resolvedActions.length > 0
            ...
            : {};
        return Object.assign({ className: css(_default$3.tableAction), style: { width: 'auto', paddingRight: 0 }, isVisible: true }, renderProps);
    };
    ...
    const TdBase = (_a) => {
        var { children, className, component = 'td', dataLabel, textCenter = false, modifier, select = null, actions = null, expand = null, treeRow: treeRowProp = null, compoundExpand: compoundExpandProp = null, noPadding, width, visibility, innerRef, favorites = null, draggableRow: draggableRowProp = null } = _a, props = __rest$2(_a, ["children", "className", "component", "dataLabel", "textCenter", "modifier", "select", "actions", "expand", "treeRow", "compoundExpand", "noPadding", "width", "visibility", "innerRef", "favorites", "draggableRow"]);
        const selectParams = select
            ? selectable(children, {
