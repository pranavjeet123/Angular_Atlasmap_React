...
export declare const withSelection: (options?: Options) => <P extends WithSelectionProps>(WrappedComponent: React.ComponentType<P>) => React.FC<Omit<P, keyof WithSelectionProps>>;
export {};
