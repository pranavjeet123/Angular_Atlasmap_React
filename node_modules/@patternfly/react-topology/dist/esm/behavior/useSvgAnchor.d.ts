...
export declare const withSvgAnchor: (end?: AnchorEnd, type?: string) => <P extends WithSvgAnchorProps>() => (WrappedComponent: React.ComponentType<P>) => React.FC<Omit<P, "svgAnchorRef">>;
