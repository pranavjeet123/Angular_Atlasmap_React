...
describe('Defs', () => {
    it('should render initially empty', () => {
        const wrapper = shallow(React.createElement(Defs, null));
    ...
    it('should render defs', () => {
        ...
        const state = {
            defs: {
                first: { count: 0, node: React.createElement("span", null) },
                second: { count: 0, node: React.createElement("span", null) },
            },
        };
...
//# sourceMappingURL=SVGDefsProvider.spec.js.map