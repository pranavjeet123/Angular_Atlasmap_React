...
class Visualization extends Stateful_1.default {
    ...
    toModel() {
        ...
        const nodes = this.getElements().filter(n => types_1.isNode(n));
        const edges = this.getElements().filter(e => types_1.isEdge(e));
        return {
            graph: graph.toModel(),
