...
export declare const withRemoveConnector: <P extends WithRemoveConnectorProps & ElementProps>(onRemove: (edge: Edge) => void, renderRemove?: RemoveRenderer) => (WrappedComponent: React.ComponentType<P>) => React.FC<Omit<P, keyof WithRemoveConnectorProps>>;
export {};
