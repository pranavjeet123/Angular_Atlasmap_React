...
const ContextSubMenuItem = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(react_core_1.DropdownItem, Object.assign({}, other, { className: "pf-topology-context-sub-menu", component: React.createElement("button", { ref: nodeRef, type: "button", 
                ...
                label,
                React.createElement(angle_right_icon_1.default, { className: "pf-topology-context-sub-menu__arrow" })) })),
        React.createElement(Popper_1.default, { open: open, placement: "right-start", closeOnEsc: true, closeOnOutsideClick: true, onRequestClose: e => {
            ...
            React.createElement("div", { ref: subMenuRef, role: "presentation", className: "pf-c-dropdown pf-m-expanded", onMouseLeave: e => {
                ...
                React.createElement(react_core_1.DropdownMenu, { className: "pf-topology-context-menu__c-dropdown__menu", autoFocus: true }, children)))));
};
